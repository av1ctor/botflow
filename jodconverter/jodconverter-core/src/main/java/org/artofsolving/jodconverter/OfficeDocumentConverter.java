...
public class OfficeDocumentConverter {
	...
	public void convert(InputStream inputFile, DocumentFormat inputFormat, OutputStream outputFile, DocumentFormat outputFormat, String pageRange) throws OfficeException {
        StandardStreamConversionTask conversionTask = new StandardStreamConversionTask(inputFile, outputFile, outputFormat, pageRange);
        conversionTask.setDefaultLoadProperties((Map<String, Object>) defaultLoadProperties);
        conversionTask.setInputFormat(inputFormat);
        officeManager.execute(conversionTask);
    }
}
